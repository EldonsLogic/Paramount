...
const th = "px-1.5 py-2 sm:px-2 text-left text-xs font-medium uppercase tracking-wide text-muted-foreground whitespace-nowrap";
...
export function ChannelRanking({ result, currency }: { result: CampaignResult; currency: CurrencyCode }) {
  ...
  return (
    <div className="relative overflow-x-auto">
      <table className="w-full min-w-[300px] border-collapse text-[13px] sm:min-w-[540px] sm:text-sm print:min-w-0">
            ...
            <tr key={r.channel.id} className="border-b last:border-0">
              ...
              <td className="px-1.5 py-3 sm:px-2">
                <span className="flex items-center gap-2 font-medium">
                  <span className="h-2.5 w-2.5 shrink-0 rounded-full" style={{ backgroundColor: r.channel.color }} aria-hidden="true" />
                  <span className="truncate">{r.channel.name || "Untitled"}</span>
                </span>
              ...
              <td className="hidden px-1.5 py-3 sm:px-2 sm:table-cell print:table-cell" aria-hidden="true">
              ...
              <td className="whitespace-nowrap px-1.5 py-3 sm:px-2 text-right font-semibold tabular-nums">{fmtInt(r.incrementalReach)}</td>
              <td className="whitespace-nowrap px-1.5 py-3 sm:px-2 text-right tabular-nums">
              ...
              <td className="hidden px-1.5 py-3 sm:px-2 text-right sm:table-cell print:table-cell">
